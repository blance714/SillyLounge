...
const CHAT_STORE_BROWSER_MODULE = '/scripts/extensions/third-party/SillyLounge-e2e/store/chat-store.js';
const MESSAGE_EDIT_DRAFT_BROWSER_MODULE = '/scripts/extensions/third-party/SillyLounge-e2e/store/message-edit-draft-store.js';
